...
#dict(type='Resize', size=(4496,3000)),
#    dict(type='CenterCrop', size=2900),
...
val_pipeline = (
        dict(type='CenterCrop', size=1000),
#dict(type='Resize', size=(4496,3000)),
#    dict(type='CenterCrop', size=2900),
...
data_cfg = dict(
    ...
    test=dict(
        ckpt = 'logs/SwinTransformer/2022-07-28-09-45-12/Train_Epoch133-Loss0.021.pth',
